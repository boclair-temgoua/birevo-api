...
describe('ApplicationService', () => {
  ...
  //         useValue: {
  //           find: jest.fn().mockResolvedValue(ApplicationArray),
  //           findOneBy: jest.fn().mockResolvedValue(oneApplication),
  //           create: jest.fn().mockResolvedValue(oneApplication),
  //           save: jest.fn().mockResolvedValue(oneApplication),
  //           update: jest.fn().mockResolvedValue(oneApplication),
  //           delete: jest.fn().mockResolvedValue(oneApplication),
  //         },
  //       },
  //     ],
  //   }).compile();
  ...
  //     const persons = await service.findAllApplications({});
  //     expect(persons).toEqual(ApplicationArray);
  //   });
  // });
